  ...
  */
						 ...
						 result);
  {
    ...
    */
    ...
    enkf_state_internalize_GEN_DATA(enkf_state , load_context , model_config , last_report , result);
    enkf_state_internalize_custom_kw(enkf_state, load_context , model_config, result);
  }
